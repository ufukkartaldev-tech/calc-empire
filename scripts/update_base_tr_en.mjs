...
trData.BaseConverter = {
  ...
  description:
    'Farklı sayı tabanları arasında dönüşüm yapın ve bit düzeyinde (Bitwise) işlemleri kopyalayarak analiz edin.',
...
enData.BaseConverter = {
  title: 'Base Converter & Bitwise Logic',
  description:
    'Convert between different number bases and visually analyze bitwise logical operations.',
