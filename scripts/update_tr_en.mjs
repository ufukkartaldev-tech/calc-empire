...
const trDashContent = {
  ...
  subtitle:
    'İhtiyacınız olan hesaplayıcıyı seçerek anında işlemlere başlayın. Temiz, sade ve hızlı.',
  backButton: 'Geri Dön',
...
const enDashContent = {
  ...
  subtitle:
    'Select the calculator you need and start computing immediately. Clean, simple, and fast.',
  backButton: 'Go Back',
