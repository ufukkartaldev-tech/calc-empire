/**
 * @file lib/guides/ohm.ts
 * @description Ohm's Law guide content
 */

export const OHM_GUIDE = `# Ohm's Law
...
- Always verify calculations with a multimeter
- Consider power ratings (P = V × I)
