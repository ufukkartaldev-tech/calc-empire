...
export function BeamDeflectionVisualizer({ className = '' }: BeamDeflectionVisualizerProps) {
  ...
  // Generate beam curve path using utility functions
  const beamPath = useMemo(() => {
    const maxDeflection = Math.min(deflection * 1000, 100); // Convert to mm and cap for visualization
  ...
  const getSupportElements = () => {
    if (beamType === 'cantilever') {
      ...
      // Pin support at left, roller support at right
      return (
        <>
          {/* Pin support */}
      ...
      <div className="mb-6 p-6 bg-gray-50 rounded-lg">
        ...
        >
          ...
          <g transform="translate(10, 0)">
            ...
            <line x1="0" y1="82" x2="0" y2="88" stroke="#6B7280" strokeWidth="1" />
            <line x1="100" y1="82" x2="100" y2="88" stroke="#6B7280" strokeWidth="1" />
            <text x="50" y="95" textAnchor="middle" fontSize="10" fill="#6B7280">
              L = {length} m
            </text>
          </g>
        </svg>
