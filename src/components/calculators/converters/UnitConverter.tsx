  ...
  },
  {
    ...
    units: [
      ...
      },
      {
        ...
        label: 'in²',
        symbol: 'in²',
        toBase: (v) => v * 6.4516e-4,
        fromBase: (v) => v / 6.4516e-4,
      },
    ],
  },
  {
  ...
  },
  {
    ...
    units: [
      ...
      },
      {
        ...
        label: 'Miliradian',
        symbol: 'mrad',
        toBase: (v) => (v * 0.18) / Math.PI,
        fromBase: (v) => (v * Math.PI) / 0.18,
      },
    ],
  },
  {
    ...
    units: [
      ...
      },
      {
        ...
        symbol: 'MB',
        toBase: (v) => v * 8388608,
        fromBase: (v) => v / 8388608,
      },
      {
        key: 'gb',
        label: 'Gigabyte',
        symbol: 'GB',
        toBase: (v) => v * 8589934592,
        fromBase: (v) => v / 8589934592,
      },
      {
        key: 'tb',
        label: 'Terabyte',
        symbol: 'TB',
        toBase: (v) => v * 8796093022208,
        fromBase: (v) => v / 8796093022208,
      },
    ],
  },
];
...
export function UnitConverter() {
  ...
  const fromUnit = useMemo(
    () => category.units.find((u) => u.key === fromKey) ?? category.units[0],
    [category, fromKey]
  );
  const toUnit = useMemo(
    () => category.units.find((u) => u.key === toKey) ?? category.units[1],
    [category, toKey]
  );
      ...
      <div className="p-6 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-[1fr_auto_1fr] gap-4 items-end">
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <div
                className={`w-full px-4 py-3 pr-20 bg-emerald-50 dark:bg-emerald-900/10 border-2 rounded-xl font-mono font-bold text-2xl min-h-[58px] flex items-center transition-all ${
                  isNaN(resultVal)
