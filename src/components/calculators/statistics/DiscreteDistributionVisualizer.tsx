        ...
        <div className="grid grid-cols-1 lg:grid-cols-[300px_1fr] gap-8">
          ...
          <div className="space-y-6">
            ...
            <div className="p-4 bg-purple-50 dark:bg-purple-900/10 border border-purple-100 dark:border-purple-900/30 rounded-2xl">
              <h4 className="text-[10px] font-black text-purple-400 uppercase mb-2">
                {t('stats')}
              </h4>
              <div className="space-y-2">
            ...
            <div className="relative h-[300px] flex items-end gap-1 px-4">
              ...
              <div className="absolute inset-0 flex flex-col justify-between pointer-events-none pb-8 pt-4">
                {[0, 0.25, 0.5, 0.75, 1].map((tick) => (
                  <div
                    key={tick}
                    className="border-t border-slate-200 dark:border-slate-800 flex items-center"
                  >
                    <span className="text-[8px] text-slate-400 -mt-3 ml-1">
                      {(tick * maxProb).toFixed(2)}
                    </span>
                  </div>
                ))}
              </div>
              ...
              {data.map((d, i) => (
                <div
                  key={i}
                  className="flex-1 flex flex-col items-center group relative h-full justify-end pb-8"
                >
                  <div
