...
export function GeometryCalculator() {
  ...
  const results = useMemo(() => {
    try {
      switch (shape) {
        case 'circle':
          return Geometry.circle(params.radius);
        case 'rectangle':
          return Geometry.rectangle(params.width, params.height);
        case 'triangle':
          return Geometry.triangle(params.base, params.height, params.sideA, params.sideB);
        case 'sphere':
          return Geometry.sphere({ radius: params.radius });
        case 'cylinder':
          return Geometry.cylinder({ radius: params.radius, height: params.height });
        case 'cone':
          return Geometry.cone({ radius: params.radius, height: params.height });
        case 'prism':
          return Geometry.rectangularPrism({
  ...
  // Render shape visualizer based on current shape
  const renderShapeVisualizer = () => {
        ...
        <svg viewBox="0 0 100 100" className="w-full h-full text-slate-400 dark:text-slate-600">
          {shape === 'circle' && (
            <g>
              ...
              <line
                ...
                strokeDasharray="2 1"
              />
              <text x="67" y="45" fontSize="5" fill={highlight} className="font-bold">
                R
              </text>
            </g>
          )}
          {shape === 'rectangle' && (
            <g>
              <rect
                ...
                strokeWidth="2"
              />
              <text x="50" y="78" fontSize="5" textAnchor="middle" fill={highlight}>
                W
              </text>
              <text
                x="12"
          ...
          {shape === 'triangle' && (
            <g>
              ...
              <line
                ...
                strokeDasharray="2 1"
              />
              <text x="50" y="88" fontSize="5" textAnchor="middle" fill={highlight}>
                Base
              </text>
              <text
                x="45"
          ...
          {shape === 'sphere' && (
            <g>
              ...
              <text x="67" y="45" fontSize="5" fill={highlight}>
                R
              </text>
            </g>
          )}
          {shape === 'cylinder' && (
            <g>
              ...
              <ellipse
                ...
                strokeWidth="2"
              />
              <text x="82" y="50" fontSize="5" fill={highlight}>
                H
              </text>
              <text x="50" y="20" fontSize="5" textAnchor="middle" fill={highlight}>
                R
              </text>
            </g>
          )}
          {shape === 'cone' && (
            <g>
              ...
              <line
                ...
                strokeDasharray="2 1"
              />
              <text x="45" y="50" fontSize="5" textAnchor="middle" fill={highlight}>
                H
              </text>
            </g>
          )}
          {shape === 'prism' && (
            <g>
              ...
              />
              <path
                d="M 20 40 L 40 20 L 80 20 L 80 50 L 60 70"
                fill="none"
                stroke={highlight}
                strokeWidth="2"
              />
              <line x1="60" y1="40" x2="80" y2="20" stroke={highlight} strokeWidth="2" />
              <text x="40" y="78" fontSize="5" textAnchor="middle" fill={highlight}>
                L
              </text>
              <text x="85" y="35" fontSize="5" textAnchor="middle" fill={highlight}>
                W
              </text>
              <text
                x="12"
        ...
        <div className="flex items-center gap-3 mb-8">
          ...
          <div>
            ...
            <p className="text-sm text-slate-500 dark:text-slate-400">
              Perfect shapes, precise calculations
            </p>
          </div>
        </div>
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <div className="space-y-1">
                      ...
                      <input
                        type="number"
                        value={params.sideA}
                        onChange={(e) => updateParam('sideA', e.target.value)}
                        className="w-full px-3 py-2 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-lg text-sm"
                      />
                    </div>
                    <div className="space-y-1">
                      ...
                      <input
                        type="number"
                        value={params.sideB}
                        onChange={(e) => updateParam('sideB', e.target.value)}
                        className="w-full px-3 py-2 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-lg text-sm"
                      />
                    </div>
                  </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
            ...
            <div className="space-y-4">
              ...
              <div className="p-4 bg-indigo-50 dark:bg-indigo-900/10 rounded-xl border border-indigo-100 dark:border-indigo-900/30">
                <p className="text-[10px] text-indigo-700/60 font-bold uppercase mb-2">
                  Math Reference
                </p>
