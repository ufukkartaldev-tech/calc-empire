          ...
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-4 pt-10 relative">
                <span className="absolute top-0 left-0 text-[10px] font-black bg-blue-600 text-white px-3 py-1 rounded-full uppercase z-10">
                  {t('point1')}
                </span>
              ...
              <div className="space-y-4 pt-10 relative">
                <span className="absolute top-0 left-0 text-[10px] font-black bg-emerald-600 text-white px-3 py-1 rounded-full uppercase z-10">
                  {t('point2')}
                </span>
            ...
            <div className="flex-1 min-h-[300px] bg-slate-50 dark:bg-slate-950 rounded-[40px] border-4 border-slate-100 dark:border-slate-800 relative overflow-hidden flex flex-col justify-center items-center group p-8 shadow-inner">
              ...
              <svg viewBox="0 0 400 300" className="w-full max-w-[400px]">
                ...
                <g
                  ...
                  style={{ transform: `translate(60px, 180px)` }}
                >
                ...
                <g
                  className="transition-transform duration-500"
                  style={{ transform: `translate(340px, 180px)` }}
                >
                  <circle r="6" fill="#10b981" filter="url(#glow)" />
                  <text
                    y="-15"
                    textAnchor="middle"
                    className="text-[12px] font-black fill-emerald-600"
                  >
                    P2
                  </text>
                </g>
              ...
              <div className="absolute bottom-6 left-1/2 -translate-x-1/2 text-center">
                ...
                <p className="text-[8px] font-mono text-slate-400 opacity-50">
                  P + ½ρv² + ρgh = constant
                </p>
              </div>
            </div>
              ...
              {result ? (
                <div className="relative z-10 space-y-2">
                  ...
                  <p className="text-[10px] font-bold opacity-50 tracking-wider">
                    {t('point' + (result.key.endsWith('1') ? '1' : '2'))}{' '}
                    {t(
                      result.key.slice(0, -1) === 'p'
                        ? 'pressure'
                        : result.key.slice(0, -1) === 'v'
                          ? 'velocity'
                          : 'height'
                    )}
                  </p>
