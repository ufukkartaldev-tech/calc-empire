  ...
  if (!result) {
    return (
      <div className="flex flex-col items-center justify-center text-slate-400 gap-2 opacity-50">
        ...
        <p className="text-[10px] font-black uppercase tracking-widest">Enter values to see diagram</p>
      </div>
    );
  }
    ...
    <div className="w-full h-full flex flex-col gap-2 p-1">
      ...
      <div className="flex-1 bg-slate-50 dark:bg-slate-950 rounded-lg border border-slate-100 dark:border-slate-800 relative overflow-hidden flex flex-col">
        <div className="flex justify-between items-center px-1 pt-1">
          <span className="text-[8px] font-black text-slate-400 uppercase tracking-tighter">SFD</span>
          <span className="text-[8px] font-bold text-emerald-600 dark:text-emerald-400">{maxShear.toFixed(1)}N</span>
        </div>
        <svg viewBox="0 0 100 40" className="w-full h-full">
          <line x1="0" y1="20" x2="100" y2="20" stroke="currentColor" className="text-slate-300 dark:text-slate-700" strokeWidth="0.5" />
          <path 
      ...
      <div className="flex-1 bg-slate-50 dark:bg-slate-950 rounded-lg border border-slate-100 dark:border-slate-800 relative overflow-hidden flex flex-col">
        <div className="flex justify-between items-center px-1 pt-1">
          <span className="text-[8px] font-black text-slate-400 uppercase tracking-tighter">BMD</span>
          <span className="text-[8px] font-bold text-blue-600 dark:text-blue-400">{maxMoment.toFixed(1)}Nm</span>
        </div>
        <svg viewBox="0 0 100 40" className="w-full h-full">
          <line x1="0" y1="5" x2="100" y2="5" stroke="currentColor" className="text-slate-300 dark:text-slate-700" strokeWidth="0.5" />
          <path 
