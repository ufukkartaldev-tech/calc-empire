...
export function BeamDeflectionVisualizer({ className = '' }: BeamDeflectionVisualizerProps) {
    ...
    if (beamType === 'cantilever') {
      return (
        <g>
          ...
          />
          <text x="105" y="15" fill="#ef4444" fontSize="12" fontWeight="500">
            W
          </text>
        </g>
      );
        ...
        <g>
          ...
          {[20, 35, 50, 65, 80].map((x) => (
            <line
              ...
              stroke="#ef4444"
              strokeWidth="2"
              markerEnd="url(#arrowhead-red-multi)"
            />
          ))}
          <text x="50" y="8" textAnchor="middle" fill="#ef4444" fontSize="12" fontWeight="500">
            w
          </text>
        </g>
      );
  ...
  return (
    <div
      className={`w-full max-w-4xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-6 shadow-sm ${className}`}
    >
      ...
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        <div className="w-full lg:w-1/3 flex flex-col gap-4">
          <div className="ce-field__control">
            <Input
              ...
              min={0.1}
              max={10}
              className="w-full bg-transparent border-none text-slate-800 dark:text-slate-100 focus:ring-0"
            />
          </div>
          <div className="ce-field__control">
            <Input
        ...
        <div className="w-full lg:w-2/3 flex flex-col gap-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div
              className={`rounded-lg p-3 text-center border flex flex-col justify-center ${
                deflection < length * 0.001
            ...
            >
              <p className="text-xs text-slate-500 font-medium mb-1 dark:text-slate-400">
                {t('status')}
              </p>
              <p
