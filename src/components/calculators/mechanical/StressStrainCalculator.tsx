        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
            ...
            <div className="p-6 bg-red-50/50 dark:bg-red-900/10 border border-red-100 dark:border-red-900/30 rounded-3xl">
              <p className="text-[10px] font-black text-red-600 dark:text-red-400 uppercase tracking-[0.2em] mb-2">Mechanical Theory</p>
              <p className="text-xs text-slate-600 dark:text-slate-400 leading-relaxed font-medium">
                Stress is measure of internal forces, while strain is measure of deformation. Hooke&apos;s Law connects them via Young&apos;s Modulus:
                <code className="block mt-2 font-mono text-red-600 dark:text-red-400 bg-white dark:bg-slate-900 p-2 rounded-lg border border-red-100 dark:border-red-900">σ = E · ε</code>
              </p>
            </div>
          </div>
          ...
          <div className="space-y-8 flex flex-col">
            ...
            <div className="flex-1 min-h-[300px] bg-slate-50 dark:bg-slate-950 rounded-[48px] border-4 border-slate-100 dark:border-slate-800 relative overflow-hidden flex flex-col items-center justify-center p-8 shadow-inner">
              <svg viewBox="0 0 200 200" className="w-full max-w-[200px]">
                ...
                {/* Force Arrows */}
                <path d="M 100 15 L 100 5 M 95 10 L 100 5 L 105 10" fill="none" stroke="#ef4444" strokeWidth="2" strokeLinecap="round" />
                <path d="M 100 185 L 100 195 M 95 190 L 100 195 L 105 190" fill="none" stroke="#ef4444" strokeWidth="2" strokeLinecap="round" />
              </svg>

              <div className="absolute bottom-6 text-center">
                <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1">Tensile Simulation</p>
                <p className="text-[8px] font-mono text-slate-300 dark:text-slate-600">Necked geometry visualized</p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="p-6 bg-slate-900 dark:bg-slate-800 rounded-[32px] shadow-xl text-white relative overflow-hidden group">
                <div className="absolute top-0 right-0 p-6 opacity-10 text-6xl font-black select-none">σ</div>
                <div className="relative z-10 space-y-1">
                  <p className="text-[10px] font-black uppercase tracking-widest opacity-60">{t('stress')}</p>
              ...
              <div className="p-6 bg-red-600 dark:bg-red-500 rounded-[32px] shadow-xl shadow-red-500/20 text-white relative overflow-hidden group">
                <div className="absolute top-0 right-0 p-6 opacity-10 text-6xl font-black select-none">ε</div>
                <div className="relative z-10 space-y-1">
                  <p className="text-[10px] font-black uppercase tracking-widest opacity-60">{t('strain')}</p>
                  <div className="flex items-baseline gap-2">
                    <span className="text-3xl font-mono font-black tracking-tighter">
                      {results ? results.strain.toLocaleString(undefined, { maximumFractionDigits: 6 }) : '---'}
                    </span>
