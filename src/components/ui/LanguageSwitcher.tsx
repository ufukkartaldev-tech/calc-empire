        ...
        >
            ...
            >
                <img
                    ...
                    className="w-5 h-auto rounded-[2px] shadow-sm border border-slate-100 dark:border-slate-700"
                    aria-hidden="true"
                />
            ...
            {isOpen && (
                ...
                >
                    <div className="py-1 max-h-72 overflow-y-auto scrollbar-thin scrollbar-thumb-slate-200 dark:scrollbar-thumb-slate-700">
                        {LOCALES.map((l) => {
