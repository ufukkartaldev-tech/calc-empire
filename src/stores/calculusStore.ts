  ...
  devtools(
    (set, get) => ({
      ...
      recalculate: () => {
        ...
        // Plot data
        const rawPlotPoints = generatePlotPoints(expression, viewBox.xMin, viewBox.xMax, PLOT_POINTS_COUNT);
        ...
        // Integral area
        const rawIntegralPoints = generatePlotPoints(expression, rangeA, rangeB, INTEGRAL_POINTS_COUNT);
