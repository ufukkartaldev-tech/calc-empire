...
test.describe('Accessibility', () => {
  test('should have proper ARIA labels', async ({ page }) => {
    ...
    await expect(page.getByRole('button', { name: /Dil Seçimi|Select Language/ })).toHaveAttribute('aria-haspopup', 'listbox');
    await expect(page.getByRole('button', { name: /Dil Seçimi|Select Language/ })).toHaveAttribute('aria-expanded', 'false');
  });
